        ...
        <div class="container">
            <div class="row row-30">
                ...
                <div class="single-product">
                    <h3 class="text-transform-none fw-medium">Avocados</h3>
        ...
        <!-- Bootstrap tabs-->
            <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-1">
                ...
                <ul class="nav nav-tabs nav-tabs-1">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-1-1" data-bs-toggle="tab">testimonials</a></li>
