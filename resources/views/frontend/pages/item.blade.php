                    ...
                    @foreach ($items as $item)
                        <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4">
                            ...
                            <article class="product">
                                ...
                                <div class="product-button"><a class="button button-secondary button-zakaria fl-bigmug-line-search74" href="{{ route('singleItem',['id' => $item->id]) }}"><i class="fas fa-eye"></i></a></div>
                                <div class="product-button"><a class="button button-primary button-zakaria fl-bigmug-line-shopping202" href="{{ route('cart.store') }}"><i class="fas fa-shopping-cart"></i></a></div>
                                </div>
                            </article>
                        </div>
                    @endforeach
