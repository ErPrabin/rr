...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-sm-6 col-md-4">
            ...
            <li>Office <a href="tel:#">+61 (409) 987–5874</a>
            </li>
            <li>Fax <a href="tel:#">+61 (409) 987–5874</a>
            </li>
            </ul>
        </div>
        <div class="col-sm-6 col-md-4">
            <h4>Address</h4>
            <div class="contacts-classic"><a href="#">Australia</a></div>
        </div>
        <div class="col-sm-6 col-md-4">
            <h4>E-mails</h4>
            <ul class="contacts-classic">
            <li><a href="mailTo:#">info@rrbiryani.org</a></li>
