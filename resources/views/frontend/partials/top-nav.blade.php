            ...
            <div class="rd-navbar-aside">
                <div class="rd-navbar-collapse">
                    <ul class="contacts-classic">
                        <li><span class="contacts-classic-title">Call us:</span> <a class="link" href="tel:#">+1 (844)
                                123 456 78</a>
                        </li>
                ...
                <div class="rd-navbar-panel">
                    ...
                    <div class="rd-navbar-brand">
                        <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark"
                                src="{{ asset('images/logo-default-234x82.png') }}" alt="" width="117"
                                height="41" /><img class="brand-logo-light"
                                src="{{ asset('images/logo-inverse-234x82.png') }}" alt="" width="117"
                                height="41" /></a>
                    </div>
                </div>
                <div class="rd-navbar-aside-element">
                    ...
                    <div class="rd-navbar-basket-wrap">
                        <button class="rd-navbar-basket fl-bigmug-line-shopping202"
                            data-rd-navbar-toggle=".cart-inline"> <i
                                class="fas fa-shopping-cart"></i><span>2</span></button>
                            ...
                            <div class="cart-inline-body">
                                    ...
                                    <div class="unit unit-spacing-sm align-items-center">
                                        <div class="unit-left"><a class="cart-inline-figure"
                                                href="single-product.html"><img
                                                    src="{{ asset('images/product-mini-1-106x104.jpg') }}" alt=""
                                                    width="106" height="104" /></a></div>
                                        <div class="unit-body">
                                            <h6 class="cart-inline-name"><a href="single-product.html">Forest Berry</a>
                                            </h6>
                                            <div>
                                ...
                                <div class="cart-inline-item">
                                    <div class="unit unit-spacing-sm align-items-center">
                                        <div class="unit-left"><a class="cart-inline-figure"
                                                href="single-product.html"><img
                                                    src="{{ asset('images/product-mini-2-106x104.jpg') }}" alt=""
                                                    width="106" height="104" /></a></div>
                                        <div class="unit-body">
                        ...
                        <li class="rd-nav-item"><a class="rd-nav-link" href="grid-shop.html">Shop</a>
                            <ul class="rd-menu rd-navbar-dropdown">
                                <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                        href="{{ route('cart.index') }}">Cart Page</a>
                                </li>
                                <li class="rd-dropdown-item"><a class="rd-dropdown-link"
